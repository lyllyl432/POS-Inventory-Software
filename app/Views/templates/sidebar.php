    <nav class="bg-secondary h-screen overflow-y-scroll fixed transition-width  ease-out md:w-56 w-20" id="side-nav">
        ...
        <ul class="mt-4">
            <li class="px-4 py-6 border-b-2">
                <div class="hidden collapsed-icon">
                    <div class="flex items-center justify-center"><svg class="inline-block align-middle m-1" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
