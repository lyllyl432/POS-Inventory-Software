    <nav class="bg-secondary h-screen overflow-y-scroll">
        <div class="flex items-center justify-between w-64 bg-accent px-4 py-6">
            <img class="max-w-12" src="<?= base_url() ?>images/logo.png" alt="logo">
