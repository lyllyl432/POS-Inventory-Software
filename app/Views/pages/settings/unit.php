...
<!-- form message cell  -->
<?= view_cell('UpdateSuccessCell', 'type=Unit') ?>
<?= view_cell('CreateSuccessCell', 'type=Unit') ?>
...
<div class="create-modal absolute top-10 left-1/2 -translate-x-1/2 z-10 w-2/5 bg-primary shadow-md px-6 py-4 hidden">
    <h2 class="text-2xl">Create Unit</h2>
    <svg xmlns="http://www.w3.org/2000/svg"
        class="w-3 cursor-pointer shrink-0 fill-gray-400 hover:fill-error absolute top-5 right-5" id="create-close-mark" viewBox="0 0 320.591 320.591">
        <path
    ...
    <form id="create-unit" method="post" class="mt-4">
...
<div class="update-modal absolute top-10 left-1/2 -translate-x-1/2 z-10 w-2/5 bg-primary shadow-md px-6 py-4 hidden">
    ...
    <svg xmlns="http://www.w3.org/2000/svg"
        class="w-3 cursor-pointer shrink-0 fill-gray-400 hover:fill-error absolute top-5 right-5 z-10" id="update-close-mark" viewBox="0 0 320.591 320.591">
        <path
            d="M30.391 318.583a30.37 30.37 0 0 1-21.56-7.288c-11.774-11.844-11.774-30.973 0-42.817L266.643 10.665c12.246-11.459 31.462-10.822 42.921 1.424 10.362 11.074 10.966 28.095 1.414 39.875L51.647 311.295a30.366 30.366 0 0 1-21.256 7.288z"
            data-original="#000000"></path>
        <path
    ...
    <form id="update-modal" method="post" class="mt-4">
