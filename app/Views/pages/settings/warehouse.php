...
<div class="flex items-center gap-4 border-b-2">
    <h1 class="text-5xl  pb-6 jus">Warehouse</h1>
    <p class="text-base text-dark-variant relative bottom-2">Settings | Warehouse</p>
</div>
<!-- form message cell  -->
<?= view_cell('UpdateSuccessCell', 'type=Warehouse') ?>
<?= view_cell('CreateSuccessCell', 'type=Warehouse') ?>
<?= view_cell('FormErrorCell') ?>
<!-- delete message cell  -->
<?= view_cell('DeleteSuccessCell', 'type=Warehouse') ?>
<div class="mt-24">
    ...
    <div class="relative overflow-x-auto warehouse-list mt-10 min-h-4">
    ...
    <div class="absolute p-4 w-full max-w-screen-md max-h-full left-1/2 -translate-x-1/2">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form id="create-warehouse" method="post" class="mt-4">
                    <div class="flex gap-10">
                        <div class="grid flex-1">
                            <label for="warehouse_name">Name</label>
                            <input id="warehouse-name" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_name">
                        </div>
                        <div class="grid flex-1">
                            <label for="warehouse_phone">Phone</label>
                            <input id="warehouse-phone" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_phone">
                        </div>
                    </div>
                    <div class="flex gap-10 mt-4">
                        <div class="grid flex-1">
                            <label for="warehouse_country">Country</label>
                            <input id="warehouse-country" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_country">
                        </div>
                        <div class="grid flex-1">
                            <label for="warehouse_city">City</label>
                            <input id="warehouse-city" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_city">
                        </div>
                    </div>
                    <div class="flex gap-10 mt-4">
                        <div class="grid flex-1">
                            <label for="warehouse_email">Email</label>
                            <input id="warehouse-email" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_email">
                        </div>
                        <div class="grid flex-1">
                            <label for="warehouse_zip_code">Warehouse Zip Code</label>
                            <input id="warehouse-zip-code" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_zip_code">
                        </div>
                    </div>
...
<div id="update" tabindex="-1" aria-hidden="true" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem) before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] max-h-full update-modal hidden">
    <div class="absolute p-4 w-full max-w-screen-md max-h-full left-1/2 -translate-x-1/2">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div class="p-4 md:p-5">
                <form id="update-warehouse" method="post" class="mt-4">
                    <input type="hidden" id="id" name="id">
                    <div class="flex gap-10">
                        <div class="grid flex-1">
                            <label for="warehouse_name">Name</label>
                            <input id="update-warehouse-name" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_name">
                        </div>
                        <div class="grid flex-1">
                            <label for="warehouse_phone">Phone</label>
                            <input id="update-warehouse-phone" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_phone">
                        </div>
                    </div>
                    <div class="flex gap-10 mt-4">
                        <div class="grid flex-1">
                            <label for="warehouse_country">Country</label>
                            <input id="update-warehouse-country" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_country">
                        </div>
                        <div class="grid flex-1">
                            <label for="warehouse_city">City</label>
                            <input id="update-warehouse-city" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_city">
                        </div>
                    </div>
                    <div class="flex gap-10 mt-4">
                        <div class="grid flex-1">
                            <label for="warehouse_email">Email</label>
                            <input id="update-warehouse-email" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_email">
                        </div>
                        <div class="grid flex-1">
                            <label for="warehouse_zip_code">Zip Code</label>
                            <input id="update-warehouse-zip-code" class="px-4 py-2 bg-dark-variant-2 rounded-xl outline-accent" type="text" name="warehouse_zip_code">
                        </div>
                    </div>
                    <button type="submit" class="btn mt-4">Submit</button>
                </form>
...
<!-- delete modal  -->
<?= view_cell('ModalDeleteCell', 'type=warehouse') ?>
